...
import { addFavorites, favorites, removeFavorites, removePost } from "../features/posts/postsSlice";

export function Star({ id }) {
    const dispatch = useDispatch();
    const favoritesId = useSelector(favorites);
    ...
    return (
        <svg
            className={favoritesId.includes(id) ? styles.activeStar : styles.star}
...
export function Edit({ handleChangePost, id }) {
    return (
        <svg
